...
def augment_image(image):
    ...
    image = tf.image.rot90(image, k=random.choice([0, 1, 2, 3]))  # Random rotation (0°, 90°, 180°, 270°)
...
def visualize_augmentation(dataset, num_samples=5):
    ...
    random_images = random.sample(dataset_images, num_samples)  # Pick 5 random images
